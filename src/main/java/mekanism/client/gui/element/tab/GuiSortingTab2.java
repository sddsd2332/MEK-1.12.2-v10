...
public class GuiSortingTab2 extends GuiTileEntityElement<TileEntityFactory> {

    public GuiSortingTab2(IGuiWrapper gui, TileEntityUltimateFactory tile, ResourceLocation def) {
