...
public class GuiSecurityTab2 extends GuiTileEntityElement<TileEntity> {

    private final EnumHand currentHand;
    private boolean isItem;

    public GuiSecurityTab2(IGuiWrapper gui, TileEntity tile, ResourceLocation def) {
    ...
    public GuiSecurityTab2(IGuiWrapper gui, ResourceLocation def, EnumHand hand) {
