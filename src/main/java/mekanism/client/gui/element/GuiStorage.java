...
public  class GuiStorage extends GuiElement {
    ...
    public GuiStorage (StorageType type, IGuiWrapper gui, ResourceLocation def, int x, int y) {
        super(MekanismUtils.getResource(MekanismUtils.ResourceType.GUI_ELEMENT, "GuiStorage.png"), gui, def);
    ...
    public enum StorageType {
        NORMAL(162,7,0,0),
        NORMAL_LOG(196,7,0,8),
        OVERLAY(162,7,0,15),
        OVERLAY_LOG(196,7,0,23),
        BASIC_FACTORY(162,17,0,31),
        ADVANCED_FACTORY(162,17,0,49),
        ELITE_FACTORY(162,17,0,67),
        ULTIMATE_FACTORY(196,17,0,85);
