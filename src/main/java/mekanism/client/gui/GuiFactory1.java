...
public class GuiFactory extends GuiMekanismTile<TileEntityFactory> {
  ...
  //      if (GuiFactory.this.tileEntity.getRecipeType() == RecipeType.SAWING || GuiFactory.this.tileEntity.getRecipeType() == RecipeType.FARM) {
   //         addGuiElement(new GuiSlot(GuiSlot.SlotType.OUTPUT ,this, resource,6,35));
  //      }
