...
public class GuiThermalEvaporationController extends GuiMekanismTile<TileEntityThermalEvaporationController> {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        fontRenderer.drawString(getStruct(), 50, 21, 0x33ff99);
        fontRenderer.drawString(LangUtils.localize("gui.height") + ": " + tileEntity.height, 50, 30, 0x33ff99);
        fontRenderer.drawString(LangUtils.localize("gui.temp") + ": " + getTemp(), 50, 39, 0x33ff99);
        renderScaledText(LangUtils.localize("gui.production") + ": " + Math.round(tileEntity.lastGain * 100D) / 100D + " mB/t", 50, 48, 0x33ff99, 76);
