...
public class FusionReactor {
    ...
    public static final int MAX_INJECTION = 5000;//this is the effective cap in the GUI, as text field is limited to 4 chars
    ...
    public void transferHeat() {
        ...
        if (activelyCooled) {
            ...
            if (waterToVaporize > 0) {
                ...
                getSteamTank().fill(new FluidStack(recipe.recipeOutput.output.getFluid(), waterToVaporize), true);
            }
    ...
    public void setInjectionRate(int rate) {
        ...
        controller.steamTank.setCapacity(TileEntityReactorController.MAX_STEAM * capRate / 50);
    ...
    public boolean hasRecipe(Fluid fluid) {
        ...
        return Recipe.FUSION_COOLING.containsRecipe(fluid);
    }
}