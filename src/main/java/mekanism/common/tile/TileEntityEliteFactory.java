...
public class TileEntityEliteFactory extends TileEntityFactory {
        ...
        public TileEntityEliteFactory() {
                ...
                configComponent.addOutput(TransmissionType.ITEM,
                                new SideData("Input", EnumColor.RED, new int[] { 5, 6, 7, 8, 9, 10, 11 }));
                configComponent.addOutput(TransmissionType.ITEM,
                                new SideData("Output", EnumColor.BLUE, new int[] { 12, 13, 14, 15, 16, 17, 18 }));
                configComponent.addOutput(TransmissionType.ITEM,
                                new SideData("Energy", EnumColor.GREEN, new int[] { 1 }));
                configComponent.addOutput(TransmissionType.ITEM,
                                new SideData("Extra", EnumColor.ORANGE, new int[] { 4 }));
                configComponent.addOutput(TransmissionType.ITEM,
                                new SideData("Input_Extra", EnumColor.PURPLE, new int[] { 4, 5, 6, 7, 8, 9, 10, 11 }));
